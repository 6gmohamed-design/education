...
function Program() {
    return (
        <>
        <div className='max-h-[800px] min-w-screen w-full p-10 mx-10' id="programs" style={{ marginBottom: "100px" }}>
        ...
        <div className='flex justify-evenly items-center gap-4 min-w-full relative flex-wrap' >
