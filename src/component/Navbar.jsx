...
function Navbar() {
  ...
  return(   
        <>
        <div className="container-fluid overflow-hidden min-w-full " >
   <nav className=" mx-5 container font-bold z-10 flex justify-center items-center rounded-lg overflow-hidden  text-white  fixed top-0 p-1 left-0 right-0 lg:min-w-screen" id="navbar" style={{ backgroundColor: 'transparent' ,padding:"10px"}}>
    <ul className="container flex space-x-6 min-w-full justify-center items-center gap-4 lg:gap-10 lg:w-full lg:justify-around ">
      <li className="flex justify-center items-center"><img src={asset} alt="logo" width={200} height={200} className="text-lg  lg:relative lg:top-0 lg:left-0  sm:relative sm:top-0 sm:left-[-200px]" /></li>
      <li className="flex justify-center items-center sm:hidden lg:block "><a href="#home" className="lg:text-xl    hover:text-amber-400 decoration-2 underline-offset-2 hover:underline transition duration-300 ease-in-out" id="item">Home</a></li>
      <li className="flex justify-center items-center sm:hidden lg:block "><a href="#programs" className="lg:text-xl   hover:text-amber-400 decoration-2 underline-offset-2 hover:underline transition duration-300 ease-in-out" id="item">programs</a></li>
      <li className="flex justify-center items-center sm:hidden lg:block "><a href="#about" className="lg:text-xl   hover:text-amber-400 decoration-2 underline-offset-2 hover:underline transition duration-300 ease-in-out" id="item">About us</a></li>
      <li className="flex justify-center items-center sm:hidden lg:block "><a href="#campus" className="lg:text-xl   hover:text-amber-400 decoration-2 underline-offset-2 hover:underline transition duration-300 ease-in-out" id="item">campus</a></li>
      <li className="flex justify-center items-center sm:hidden lg:block "><a href="#testmonials" className="lg:text-xl   hover:text-amber-400 decoration-2 underline-offset-2 hover:underline transition duration-300 ease-in-out" id="item">testimonials</a></li>
      <li className="flex justify-center items-center sm:hidden lg:block "> <button className="lg:text-xl   rounded-lg border border-white bg-amber-400 hover:bg-white hover:text-black py-6 px-10 w-[110px] lg:w-[150px]" id="item">
